...
function HeroHighlights({ items = [] }) {
  ...
  return (
    <div className="hero-highlight-panel" aria-label="Flexify stats and highlights">
      {items.map(({ value, label, helper }) => (
...
function Home() {
      ...
      <div className="home-container">
        <div className="hero-section">
          <div className="hero-copy">
            <p className="hero-pill">Logged in as user</p>
            <h1 className="hero-title">Welcome back, {firstName || 'User'}</h1>
          ...
          <HeroHighlights
            items={[
              { value: '3 steps', label: 'Book in minutes', helper: 'Choose · Pay · Relax' },
              { value: '4.9 ★', label: 'Average rating', helper: 'Trusted pros near you' },
              { value: '< 60 min', label: 'Avg. provider response', helper: 'Stay in the loop' }
            ]}
          />
        </div>
  ...
  if (role === 'provider') {
    return (
      <div className="home-container">
        <div className="hero-section">
          <div className="hero-copy">
            <p className="hero-pill provider-pill">Provider mode</p>
            <h1 className="hero-title">Welcome, {firstName || 'Provider'}</h1>
          ...
          <HeroHighlights
            items={[
              { value: 'New', label: 'Requests today', helper: 'Stay responsive to climb ranks' },
              { value: '₹75k+', label: 'Avg. monthly earnings', helper: 'For active providers' },
              { value: '98%', label: 'On-time visits', helper: 'Keep your streak going' }
            ]}
          />
        </div>
        <div className="features-section">
  ...
  if (role === 'admin') {
    return (
      <div className="home-container">
        <div className="hero-section">
          <div className="hero-copy">
            <p className="hero-pill admin-pill">Admin access</p>
          ...
          <HeroHighlights
            items={[
              { value: '420+', label: 'Active providers', helper: 'Monitoring compliance' },
              { value: '65', label: 'Pending verifications', helper: 'Needs quick review' },
              { value: '99.3%', label: 'System uptime', helper: 'Realtime ops healthy' }
            ]}
          />
        </div>
      </div>
  ...
  return (
    <div className="home-container">
      <div className="hero-section">
        <div className="hero-copy">
          <p className="hero-pill">Trusted marketplace</p>
        ...
        <HeroHighlights
          items={[
            { value: '15k+', label: 'Bookings completed', helper: 'Pan-India coverage' },
            { value: '4.9 ★', label: 'Average rating', helper: 'Loved by our customers' },
            { value: '500+', label: 'Verified providers', helper: 'Background checked' }
          ]}
        />
      </div>
        ...
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p style={{ marginTop: '1rem' }}>
              <strong>Phone:</strong> <a href="tel:+919611283288" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>+91 9611283288</a><br/>
              <strong>Email:</strong> <a href="mailto:ajayhegde2004@gmail.com" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>ajayhegde2004@gmail.com</a>
            </p>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              <li><a href="mailto:ajayhegde2004@gmail.com">Contact Us : </a></li>
              <li><a href="tel:+919611283288">Call Us: +91 9611283288</a></li>
              <li><a href="mailto:ajayhegde2004@gmail.com">Mail Us: ajayhegde2004@gmail.com</a></li>
